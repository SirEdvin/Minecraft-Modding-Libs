...
abstract class EnergyStorageTests {
    ...
    fun testMoveTo() {
        ...
        assertEquals(500L, moved)
        assertEquals(500L, from.firstEnergy.amount)
        assertEquals(1000L, to.firstEnergy.amount)
    }
    ...
    fun testMoveToFailed() {
        ...
        assertEquals(1000L, from.firstEnergy.amount)
        assertEquals(defaultUnits, from.firstEnergy.unit)
        assertEquals(500L, to.firstEnergy.amount)
    ...
    fun testMoveToEmpty() {
        ...
        assertEquals(0L, from.firstEnergy.amount)
        assertEquals(defaultUnits, from.firstEnergy.unit)
        assertEquals(1000L, to.firstEnergy.amount)
    ...
    fun testPredicateSearch() {
        ...
        assertEquals(1000L, movedAmount)
        assertEquals(0L, from.firstEnergy.amount)
        assertEquals(defaultUnits, from.firstEnergy.unit)
        assertEquals(1000L, to.firstEnergy.amount)
        assertEquals(defaultUnits, to.firstEnergy.unit)
    ...
    fun testFailedPredicateSearch() {
        ...
        val movedAmount = from.moveTo(to, 1000, takePredicate = predicate)
        assertEquals(0L, movedAmount)
        assertEquals(1000L, from.firstEnergy.amount)
        assertEquals(DUMMY_ENERGY, from.firstEnergy.unit)
        assertEquals(0L, to.firstEnergy.amount)
        assertEquals(defaultUnits, to.firstEnergy.unit)
    }
}
