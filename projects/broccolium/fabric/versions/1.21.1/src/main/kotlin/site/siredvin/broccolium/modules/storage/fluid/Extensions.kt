...
fun FluidVariant.toVanilla(count: Double = 1.0): AgnosticFluidStack = AgnosticFluidStack(this.fluid, count / PlatformToolkit.get().fluidCompactDivider, this.components)
