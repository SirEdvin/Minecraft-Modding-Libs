...
class TweakedSmithingTransformRecipeBuilder(
    ...
    companion object {
        fun smithingTransform(template: Ingredient, base: Ingredient, addition: Ingredient, item: Item): TweakedSmithingTransformRecipeBuilder = TweakedSmithingTransformRecipeBuilder(RecipeSerializer.SMITHING_TRANSFORM, template, base, addition, item)
    }
